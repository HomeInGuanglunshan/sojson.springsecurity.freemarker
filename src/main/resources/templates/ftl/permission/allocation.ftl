	...
	<head>
		...
		<script >
			so.init(function(){
				...
				<@security.authorize access="hasAuthority('/permission/clearPermissionByRoleIds.shtml')">
				//全选
			...
			<@security.authorize access="hasAuthority('/permission/addPermission2Role.shtml')">
			<#--选择权限后保存-->
