        ...
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	          ...
	          <ul class="nav navbar-nav" id="topMenu">
				...
				<@security.authorize access="hasAnyRole('888888','100002')">
				<li class="dropdown ${(index==2)?string('active','')}">
					...
					<ul class="dropdown-menu">
						<@security.authorize access="hasAuthority('/member/list.shtml')">
							<li><a href="${basePath}/member/list.shtml">用户列表</a></li>
						</@security.authorize>
						<@security.authorize access="hasAuthority('/member/online.shtml')">
				...
				<@security.authorize access="hasAnyRole('888888','100003')">
					<li class="dropdown ${(index==3)?string('active','')}">
						...
						<ul class="dropdown-menu">
							<@security.authorize access="hasAuthority('/role/index.shtml')">
								<li><a href="${basePath}/role/index.shtml">角色列表</a></li>
							</@security.authorize>
							<@security.authorize access="hasAuthority('/role/allocation.shtml')">
								<li><a href="${basePath}/role/allocation.shtml">角色分配（这是个JSP页面）</a></li>
							</@security.authorize>
							<@security.authorize access="hasAuthority('/permission/index.shtml')">
								<li><a href="${basePath}/permission/index.shtml">权限列表</a></li>
							</@security.authorize>
							<@security.authorize access="hasAuthority('/permission/allocation.shtml')">
