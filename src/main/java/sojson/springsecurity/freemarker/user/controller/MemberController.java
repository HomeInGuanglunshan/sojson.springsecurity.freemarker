...
public class MemberController extends BaseController {
	...
	public ModelAndView online() {
		List<UserOnlineBo> list = sessionUtils.getAllUsers();
	...
	public ModelAndView onlineDetails(@PathVariable("sessionId") String sessionId) {
		UserOnlineBo bo = sessionUtils.getSession(sessionId);
	...
	public Map<String, Object> changeSessionStatus(Boolean status, String sessionIds) {
		return sessionUtils.changeSessionStatus(status, sessionIds);
	}
